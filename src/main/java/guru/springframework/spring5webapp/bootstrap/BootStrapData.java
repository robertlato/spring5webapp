...
public class BootStrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Book ddd = new Book("Domain Driven Design", "1234554");
        ...
        Book noEJB = new Book("J2EE Development without EJB", "534523432");
        ...
        Publisher helios = new Publisher("Helios", "Gdanska 32", "Tczew", "Pomorskie", "83110");
